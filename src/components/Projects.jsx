...
//   return (
//     <div className="flex flex-col items-center pt-16 w-full overflow-hidden">
//       {/* ---------- HEADING + DESCRIPTION (WHITE SECTION) ---------- */}
...
//           energy solution tailored to industrial requirements.
//           <br />
//           <br />
//           High-efficiency{" "}
//           <span className="font-semibold text-green-500">
...
//           </span>{" "}
//           with integrated{" "}
//           <span className="font-semibold text-green-500">power optimizers</span>{" "}
//           and a{" "}
//           <span className="font-semibold text-green-500">
//             SolarEdge inverter
//           </span>{" "}
//           ensure optimal energy conversion and long-term operational stability.
//           <br />
//           <br />
//           The system significantly reduces electricity costs while lowering the
//           facility’s{" "}
//           <span className="font-semibold text-green-500">carbon footprint</span>
//           .
//         </p>
//       </div>

//       {/* ---------- GREEN SECTION (CAROUSEL + STATUS TABS) ---------- */}
...
//         {/* Status Tabs (NOW INSIDE GREEN BACKGROUND) */}
